  ...
  return (
    <div className="mx-auto max-w-[1240px] px-6 py-10">
      <div className="mx-auto mb-10 max-w-[640px] text-center">
        ...
        <p className="text-[14.5px] leading-8 text-ink/50">
      ...
      <div className="mb-10 grid grid-cols-1 gap-5 sm:grid-cols-2">
        <div className="rounded-card border border-black/5 bg-white p-7">
          <h3 className="mb-2.5 font-bold">مأموریت ما</h3>
          <p className="text-[13.5px] leading-8 text-ink/50">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-5">
        {values.map((v) => (
          <div key={v} className="rounded-2xl border border-black/5 bg-white p-4 text-center text-sm font-bold">
            {v}
          </div>
        ))}
      </div>
