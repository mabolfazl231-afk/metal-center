  ...
  return (
    <div className="mx-auto max-w-[1240px] px-6 py-10">
      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
        {factories.map((f) => (
          <div key={f.name} className="overflow-hidden rounded-card border border-border-light bg-white dark:border-border-dark dark:bg-surface-dark shadow-soft">
            ...
            <div className="p-5">
              ...
              <div className="mt-1 text-xs text-ink/50 dark:text-white/40">{f.location}</div>
              <div className="mt-3 border-t border-black/5 pt-3 text-xs text-ink/50 dark:text-white/40">
