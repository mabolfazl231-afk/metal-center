  ...
  return (
    <div className="mx-auto max-w-[1240px] px-6 py-10">
      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
        {articles.map((a) => (
          <article key={a.title} className="overflow-hidden rounded-card border border-border-light bg-white dark:border-border-dark dark:bg-surface-dark shadow-soft">
            ...
            <div className="p-4">
              ...
              <div className="text-[11.5px] text-ink/50 dark:text-white/40">{a.time} مطالعه</div>
            </div>
          </article>
        ))}
      </div>
