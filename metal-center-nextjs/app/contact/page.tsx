  ...
  return (
    <div className="mx-auto max-w-[1240px] px-6 py-10">
      <div className="mb-8 text-center">
        ...
        <p className="mx-auto max-w-[520px] text-[14.5px] text-ink/50 dark:text-white/40">
      ...
      <div className="mb-10 grid grid-cols-2 gap-3.5 lg:grid-cols-4">
        {info.map((i) => (
          <div key={i.t1} className="rounded-2xl border border-border-light bg-white dark:border-border-dark dark:bg-surface-dark p-5 text-center">
            <div className="mb-1 text-sm font-bold">{i.t1}</div>
            <div className="text-xs text-ink/50 dark:text-white/40" dir="ltr">{i.t2}</div>
          </div>
        ))}
      </div>

      <div className="mx-auto max-w-[640px] rounded-card border border-border-light bg-white dark:border-border-dark dark:bg-surface-dark p-7">
